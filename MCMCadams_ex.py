...
t0 = time.time()
locations,values,lams = MCMCadams(niter,100,newGP,pointpo,nInsDelMov,10,0.1,10,700,10000,p=True)
t1 = time.time()
...
meanGP = np.mean(resGP[400:], axis=0, dtype=np.float32)
